...
void AddBackEdge(string varsInfo, int n)
{
	...
	//cout << "num=" << num << "  currentNode=" << currentNode << "  to=" << to << endl;
...
{
	//cout << "FindSameNode" << endl;
	//printf("%s  %s\n", pStatementNum, VarInfo);
...
{
	//cout << "***********HandleSameNode***********" << endl;

	int n = FindSameNode(pStatementNum, pVarInfo);

	//cout << "sameNode="<< n << endl;
...
void GenerateEdge(const char* pVarsInfo, int isEmpty)
{
	...
	if (*currentOr == *lengthOr)//只在新的分支之后添加新的边
	{
		...
		//cout << "num=" << num << "  currentNode=" << currentNode << "  to=" << lastNode + 1 <<"  isEmpty="<< isEmpty << endl;
...
{
	//cout << "Save" << "  *currentOr=" << *currentOr << "  currentNode=" << currentNode << endl;
...
void UpdateCurrentNode()
{
	...
	//cout << "Update" << "  *currentOr=" << *currentOr << "  currentNode=" << currentNode << endl;
}
